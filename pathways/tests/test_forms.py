...
class HouseholdSizeFormTest(TestCase):
    ...
    def test_help_text_correct(self):
        form = forms.HouseholdSizeForm(data={})
        self.assertEqual(form['household_size'].help_text, _("This is how many people you regularly share living expenses with, including yourself. If you live with them, include children, spouses/partners, and parents."))
